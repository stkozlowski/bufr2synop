...
b) resulting converted GTS files are in standard meteo bulletin format.

For instance:

file 20200607170000_ISND01_EDZW_071700_RRA.bufr
is converted to text file:
...
bufrtotac.exe works on unpacked files.
